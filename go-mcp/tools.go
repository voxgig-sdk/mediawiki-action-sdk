...
func registerTools(server *mcp.Server, client *sdk.MediawikiActionSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "mediawiki-action_list",
		Description: "List records from MediawikiAction. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "mediawiki-action_load",
		Description: "Load a single record from MediawikiAction. " +
...
func runOp(client *sdk.MediawikiActionSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MediawikiActionSDK, name string) (sdk.MediawikiActionEntity, error) {
