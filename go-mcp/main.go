// Command MediawikiAction-mcp is an MCP server exposing the MediawikiAction
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MediawikiAction_list  — list records of an entity
//	MediawikiAction_load  — load a single record of an entity
//
