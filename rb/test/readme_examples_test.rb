...
#      offline in seeded test mode (MediawikiActionSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MediawikiAction_sdk.rb")
  SDK_CLASS = "MediawikiActionSDK"
