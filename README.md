...
A web service providing access to wiki features like authentication, page operations, and search.

Learn more about MediaWiki Action API at [www.mediawiki.org/wiki/API:Main_page#](https://www.mediawiki.org/wiki/API:Main_page#).
...
| Python | `voxgig-sdk-mediawiki-action-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/mediawiki-action-sdk/tags) |
| PHP | `voxgig-sdk/mediawiki-action-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/mediawiki-action-sdk/tags) |
| Golang | `github.com/voxgig-sdk/mediawiki-action-sdk/go` | `go get github.com/voxgig-sdk/mediawiki-action-sdk/go@latest` |
| Ruby | `voxgig-sdk-mediawiki-action-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/mediawiki-action-sdk/tags) |
| Lua | `voxgig-sdk-mediawiki-action-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/mediawiki-action-sdk/tags) |
