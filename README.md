...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/mediawiki-action` | `npm install @voxgig-sdk/mediawiki-action` |
| Python | `voxgig-sdk-mediawiki-action` | `pip install voxgig-sdk-mediawiki-action` |
| PHP | `voxgig-sdk/mediawiki-action` | `composer require voxgig-sdk/mediawiki-action` |
| Golang | `github.com/voxgig-sdk/mediawiki-action-sdk/go` | `go get github.com/voxgig-sdk/mediawiki-action-sdk/go` |
| Ruby | `voxgig-sdk-mediawiki-action` | `gem install voxgig-sdk-mediawiki-action` |
| Lua | `voxgig-sdk-mediawiki-action` | `luarocks install voxgig-sdk-mediawiki-action` |
