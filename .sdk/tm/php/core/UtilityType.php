...
// MediawikiAction SDK utility type

class MediawikiActionUtility
{
    ...
    public static function copy(MediawikiActionUtility $src): MediawikiActionUtility
    {
        $u = new MediawikiActionUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
