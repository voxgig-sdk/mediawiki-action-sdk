...
// MediawikiAction SDK pipeline test
//
...
{
    private static function utility(): MediawikiActionUtility
    {
        return new MediawikiActionUtility();
    }
    ...
    private static function ctx(array $over = []): MediawikiActionContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MediawikiActionContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MediawikiActionOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MediawikiActionError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MediawikiActionOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MediawikiActionMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MediawikiActionOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MediawikiActionMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MediawikiActionOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MediawikiActionMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MediawikiActionSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MediawikiActionMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MediawikiActionResponse([]),
            'result' => new MediawikiActionResult([]),
        ]);
        [, $err] = MediawikiActionMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MediawikiActionSpec([]),
            'response' => null,
            'result' => new MediawikiActionResult([]),
        ]);
        [, $err] = MediawikiActionMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MediawikiActionSpec(['step' => 's']),
            'response' => new MediawikiActionResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MediawikiActionResult([]),
        ]);
        [, $err] = MediawikiActionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MediawikiActionSpec(['step' => 's']),
            'response' => new MediawikiActionResponse(self::resp(200, ['v' => 1])),
            'result' => new MediawikiActionResult([]),
        ]);
        [, $err] = MediawikiActionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MediawikiActionSpec(['step' => 's']),
            'response' => new MediawikiActionResponse(self::resp(200, ['v' => 2])),
            'result' => new MediawikiActionResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MediawikiActionMakeResponse::call($ctx);
    ...
    {
        $preset = new MediawikiActionResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MediawikiActionSpec([]),
            'response' => new MediawikiActionResponse([]),
            'result' => new MediawikiActionResult([]),
        ...
        [$got, $err] = MediawikiActionMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MediawikiActionResult([])]);
        [, $err] = MediawikiActionMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MediawikiActionSpec([]), 'result' => null]);
        [, $err] = MediawikiActionMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MediawikiActionSpec(['step' => 's']),
            'result' => new MediawikiActionResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MediawikiActionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MediawikiActionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MediawikiActionSpec(['step' => 's']),
            'result' => new MediawikiActionResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MediawikiActionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MediawikiActionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MediawikiActionResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MediawikiActionSpec([]),
            'result' => new MediawikiActionResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MediawikiActionMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MediawikiActionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MediawikiActionError('boom', 'boom');
        $utility->fetcher = function (MediawikiActionContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MediawikiActionSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MediawikiActionMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MediawikiActionContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MediawikiActionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MediawikiActionResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MediawikiActionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MediawikiActionContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MediawikiActionSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MediawikiActionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MediawikiActionResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MediawikiActionSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MediawikiActionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MediawikiActionMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MediawikiActionMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MediawikiActionResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MediawikiActionDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MediawikiActionResult(['ok' => false])]);
        $this->expectException(MediawikiActionError::class);
        MediawikiActionDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MediawikiActionResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MediawikiActionMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MediawikiActionMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MediawikiActionBaseFeature();
        $b = new MediawikiActionBaseFeature();
        MediawikiActionFeatureAdd::call($ctx, $a);
        MediawikiActionFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MediawikiActionBaseFeature
    {
        $f = new MediawikiActionBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MediawikiActionFeatureAdd::call($ctx, self::named_feature('a'));
        MediawikiActionFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MediawikiActionFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MediawikiActionFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MediawikiActionFeatureAdd::call($ctx, $replace);
        ...
        MediawikiActionFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?MediawikiActionSpec $spec): MediawikiActionContext
    {
    ...
    private static function auth_bags(): MediawikiActionSpec
    {
        return new MediawikiActionSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        MediawikiActionPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MediawikiActionPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MediawikiActionResponse(['headers' => null]),
            'result' => new MediawikiActionResult([]),
        ]);
        MediawikiActionResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MediawikiActionResultBody::call($ctx);
