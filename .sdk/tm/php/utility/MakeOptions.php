...
// MediawikiAction SDK utility: make_options

class MediawikiActionMakeOptions
{
    ...
    public static function call(MediawikiActionContext $ctx): array
    {
        ...
        //
        // `MediawikiActionSchema::optspec()` is built from the model:
        ...
        $optspec = MediawikiActionSchema::optspec();
