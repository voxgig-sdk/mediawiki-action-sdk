...
// MediawikiAction SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MediawikiActionMakeRequest
{
    public static function call(MediawikiActionContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MediawikiActionResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MediawikiActionResponse($fetched);
        } else {
