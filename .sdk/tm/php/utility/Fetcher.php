...
class MediawikiActionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MediawikiActionSDK/1.0)';
    ...
    public static function call(MediawikiActionContext $ctx, string $fullurl, array $fetchdef): array
    {
