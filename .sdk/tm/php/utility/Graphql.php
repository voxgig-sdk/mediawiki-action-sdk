...
// MediawikiAction SDK utility: graphql
//
...
class MediawikiActionGraphql
{
    ...
    // equivalent.
    public static function body(MediawikiActionContext $ctx): mixed
    {
    ...
    public static function errors(MediawikiActionContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
