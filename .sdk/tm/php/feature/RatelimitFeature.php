...
// MediawikiAction SDK ratelimit feature
...
class MediawikiActionRatelimitFeature extends MediawikiActionBaseFeature
{
    ...
    private function _acquire(MediawikiActionContext $ctx): void
    {
    ...
    private function _track(MediawikiActionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
