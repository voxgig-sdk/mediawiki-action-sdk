...
// MediawikiAction SDK audit feature
...
class MediawikiActionAuditFeature extends MediawikiActionBaseFeature
{
    ...
    private function _emit(MediawikiActionContext $ctx, string $outcome): void
    {
