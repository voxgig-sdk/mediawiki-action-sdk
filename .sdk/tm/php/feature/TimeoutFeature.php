...
// MediawikiAction SDK timeout feature
...
class MediawikiActionTimeoutFeature extends MediawikiActionBaseFeature
{
    ...
    private function _with_timeout(MediawikiActionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MediawikiActionContext $_ctx, float $ms): void
    {
        $client = $this->client;
