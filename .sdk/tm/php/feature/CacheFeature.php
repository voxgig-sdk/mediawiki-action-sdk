...
// MediawikiAction SDK cache feature
...
class MediawikiActionCacheFeature extends MediawikiActionBaseFeature
{
    ...
    private function _through(MediawikiActionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
