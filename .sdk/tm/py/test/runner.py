...
class MediawikiActionTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MediawikiActionTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MediawikiActionTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MediawikiActionTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
