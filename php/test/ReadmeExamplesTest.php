...
// MediawikiAction SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MediawikiActionSDK::test)
...
{
    private const SDK_CLASS = 'MediawikiActionSDK';
    ...
    private const SDK_BASE = 'mediawikiaction_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mediawikiaction_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
