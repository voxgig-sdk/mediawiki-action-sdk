...
// MediawikiAction SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MediawikiActionOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MediawikiActionOmni::structfix($now, Struct::undef()))
                        !== json_encode(MediawikiActionOmni::structfix($val, Struct::undef()))) {
