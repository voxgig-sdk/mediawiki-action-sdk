...
// MediawikiAction SDK netsim feature
...
class MediawikiActionNetsimFeature extends MediawikiActionBaseFeature
{
    ...
    private function _simulate(MediawikiActionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MediawikiActionContext $ctx, array $applied): void
    {
        $client = $this->client;
