...
// MediawikiAction SDK streaming feature
...
class MediawikiActionStreamingFeature extends MediawikiActionBaseFeature
{
    ...
    private function _iterate(MediawikiActionResult $result): \Generator
    {
    ...
    private function _streamable(MediawikiActionContext $ctx): bool
    {
