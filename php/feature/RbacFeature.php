...
// MediawikiAction SDK rbac feature
...
class MediawikiActionRbacFeature extends MediawikiActionBaseFeature
{
    ...
    private function _required(MediawikiActionContext $ctx): ?string
    {
    ...
    private function _reject(MediawikiActionContext $ctx, string $required): void
    {
    ...
    private function _track(MediawikiActionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
