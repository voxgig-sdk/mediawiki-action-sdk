...
// MediawikiAction SDK clienttrack feature
...
class MediawikiActionClienttrackFeature extends MediawikiActionBaseFeature
{
    ...
    public function PostConstruct(MediawikiActionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MediawikiAction-SDK';
