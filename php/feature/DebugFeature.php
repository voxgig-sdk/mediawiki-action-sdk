...
// MediawikiAction SDK debug feature
...
class MediawikiActionDebugFeature extends MediawikiActionBaseFeature
{
    ...
    private function _finish(MediawikiActionContext $ctx, bool $ok): void
    {
