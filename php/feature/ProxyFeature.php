...
// MediawikiAction SDK proxy feature
...
class MediawikiActionProxyFeature extends MediawikiActionBaseFeature
{
    ...
    public function init(MediawikiActionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MediawikiActionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
