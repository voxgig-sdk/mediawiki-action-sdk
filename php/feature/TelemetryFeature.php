...
// MediawikiAction SDK telemetry feature
...
class MediawikiActionTelemetryFeature extends MediawikiActionBaseFeature
{
    ...
    private function _close(MediawikiActionContext $ctx, bool $ok): void
    {
