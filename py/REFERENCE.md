# MediawikiAction Python SDK Reference

Complete API reference for the MediawikiAction Python SDK.
...
#### `MediawikiActionSDK.test(testopts=None, sdkopts=None)`
...
```python
result = client.Api().load({"action": "action"})
```
