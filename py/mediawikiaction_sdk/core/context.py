...
from mediawikiaction_sdk.core.control import MediawikiActionControl
...
from mediawikiaction_sdk.core.helpers import get_ctx_prop, to_map
...
class MediawikiActionContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MediawikiActionControl()
        ...
        if isinstance(sp, MediawikiActionSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MediawikiActionResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MediawikiActionResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MediawikiActionOperation({})
    ...
    def make_error(self, code, msg):
        return MediawikiActionError(code, msg, self)
