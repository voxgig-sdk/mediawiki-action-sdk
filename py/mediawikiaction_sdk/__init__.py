...
from mediawikiaction_sdk.utility import register

# Load features
from mediawikiaction_sdk.feature.base_feature import MediawikiActionBaseFeature
from mediawikiaction_sdk.features import _has_feature, _make_feature
...
class MediawikiActionSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MediawikiActionUtility()
        self._utility = utility

        from mediawikiaction_sdk.config import shared_config
    ...
    def get_utility(self):
        return MediawikiActionUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MediawikiActionSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Api(self, data=None) -> "ApiEntity":
        ...
        from mediawikiaction_sdk.entity.api_entity import ApiEntity
        return ApiEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MediawikiActionSDK":
        if sdkopts is None:
            sdkopts = {}
