# MediawikiAction Python SDK



The Python SDK for the MediawikiAction API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/mediawiki-action-sdk/releases)) or
...
```
py/
├── mediawikiaction_sdk.py         -- Main SDK module
...
The main module (`mediawikiaction_sdk`) exports the SDK class.
