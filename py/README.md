...
The Python SDK for the MediawikiAction API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
# Create
created, _ = client.Api(None).create({"name": "Example"}, None)
...
result, err = client.MediawikiAction(None).load(
    {"id": "test01"}, None
)
