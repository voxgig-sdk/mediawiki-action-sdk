# MediawikiAction SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MediawikiActionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MediawikiActionSDK(...) and MediawikiActionSDK.test(...) become
#      MediawikiActionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mediawikiaction_sdk"
_SDK_CLASS = "MediawikiActionSDK"
