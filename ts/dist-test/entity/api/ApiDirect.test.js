...
(0, node_test_1.describe)('ApiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MediawikiActionSDK({
...
function liveScenariosActive() { return false && process.env.MEDIAWIKI_ACTION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MediawikiActionSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.MEDIAWIKI_ACTION_APIKEY,
        }));
        let idmap = env['MEDIAWIKI_ACTION_TEST_API_ENTID'];
    ...
    const client = new __1.MediawikiActionSDK({
        base: 'http://localhost:8080',
