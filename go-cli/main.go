// Command MediawikiAction-cli is a CLI + REPL for the MediawikiAction SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MEDIAWIKI_ACTION_APIKEY (api key), MEDIAWIKI_ACTION_BASE (base url override)")
