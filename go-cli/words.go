...
func registerSDKWords(r *eng.Registry, client *sdk.MediawikiActionSDK) {
...
func runOp(client *sdk.MediawikiActionSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
