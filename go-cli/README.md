...
AQL-driven CLI and REPL for the MediawikiAction SDK. Positional arguments are
...
```sh
go build -o mediawiki-action-cli ./...
```
...
./mediawiki-action-cli list api
./mediawiki-action-cli load 1 api
./mediawiki-action-cli load '{id:1}' api
